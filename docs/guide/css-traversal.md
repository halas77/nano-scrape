...
| :--- | :--- | :--- | :--- |
| **Tag Name** | `tag` | `div` | Matches all `<div>` elements |
| **Class** | `.class` | `.price` | Matches elements with `class="price"` |
| **ID** | `#id` | `#main-content` | Matches element with `id="main-content"` |
| **Attribute** | `[attr=val]` | `[data-category="books"]` | Matches elements with specific attribute values |
| **Descendant** | `A B` | `article .title` | Matches `.title` nested inside `<article>` |
| **Child** | `A > B` | `ul > li` | Matches `<li>` that are direct children of `<ul>` |
